...
%
These aspects, if not taken into consideration may call into question the credibility of the evidence. 
%
This work analyzes proposals in the literature aimed at solving such challenges, discussing its limitations and proposes a solution that covers collection, transportation and storage of evidence, aiming at overcoming existing limitations in the state of art.
%
...
%
For this, containers are used for their ability to preserve the relationship evidence-source even though the latter does not exist in the system under investigation.
%
