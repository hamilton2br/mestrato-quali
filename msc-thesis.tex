...
\titulo{Dizang: Uma solução para coleta de evidências forenses de ataques de injeção na nuvem}
...
%
Na minha terra tem palmeiras onde canta o sabiá, seno(a)*cosseno(b) = seno(b)*cosseno(a)
\end{abstract}
...
\begin{listofabbrv}{FlexDHE}
    \item [ABV1] Abreviação 1
    \item [ABV2] Abreviação 2
    \item [ABV3] Abreviação 3
    \item [ABV4] Abreviação 4
    \item [ABV5] Abreviação 5
\end{listofabbrv}
...
\input{chapters/ForenseNuvem.tex}
