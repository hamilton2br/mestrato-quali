...
%
Estes aspectos, se não forem levados em consideração, podem colocar em xeque a credibilidade das evidências.
%
...
%
A solução proposta, denominada Danzig, provê uma forma de correlacionar evidências e sua origem virtual, permitindo transportar e armazenar tais dados sem afetar sua credibilidade.
%
Para tal, é feito o uso de contêineres e seus respectivos identificadores, técnica esta que tem a vantagem que conseguir preservar a relação evidência-origem mesmo que esta última não exista mais na solução sob investigação.
%
Em resumo, Danzig tem como focos (1) a reprodutibilidade do processo de coleta, (2) o estabelecimento de um vínculo entre a evidência coletada e sua origem, (3) a preservação da jurisdição e da privacidade de usuários não envolvidos na investigação e (4) a garantia de custódia da evidência.
%
\end{resumo}

\begin{abstract}
\marcos{Reescreva considerando as revisões na parte em português.}
