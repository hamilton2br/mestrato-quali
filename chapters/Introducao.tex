...
%
Técnicas de virtualização, replicação de serviços e compartilhamento de recursos entre múltiplos usuários (multi-inquilinato) proveem à nuvens computacionais uma elevada escalabilidade \cite{MorsyCloudSecurity:2010}.
%
