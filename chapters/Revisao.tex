...
\marcos{Explique melhor as soluções: você tem espaço, então pode deixar este capítulo muito mais autocontido - Hamilton: Feito}
...
\begin{figure}[htb!]
\footnotesize
\caption{FoRensic Open Stack Tools}
...
\begin{figure}[htb!]
\footnotesize
\caption{Digital Forensic as a Service - Indexed Data}
\includegraphics[scale=0.50]{FaaSIndexedSearch.png}
\centering
