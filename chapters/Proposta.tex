...
\marcos{Mais atenção ao tempo verbal... você fica usando frases no futuro para as fases 1 e 2, e depois diz que já foram executadas (=passado)...?! Só confunde o leitor...}
...
\begin{figure}[htb!]
\footnotesize
\caption{Cronograma de projeto. \marcos{Ficou meio pequeno... melhor colocar números (e.g., em romanos) na primeira coluna e logo abaixo da tabela (ou mesmo aqui na legenda) colocar o que cada número significa.}}
