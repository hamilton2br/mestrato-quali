...
%
A comparação de instantâneos de memória coletados em diferentes instantes de tempo permite a identificação de injeção de código assim como extraír o conteúdo da parte legível do endereço de memória correspondente.
