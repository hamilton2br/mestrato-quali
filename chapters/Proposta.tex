...
%
Embora as coletas via cópia do diretório \textbf{/proc/pid/numa\_maps} tenham sido bem sucedidas, não foi possível realizar a cópia crua da memória do processo do contêiner via \textit{GDB}. 
%
...
%
Sendo assim o presente trabalho optou por limitar a análise apenas às evidências coletadas via cópia do diretório \textbf{/proc/pid/numa\_maps}.
