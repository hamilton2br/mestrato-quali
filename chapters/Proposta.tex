...
%
A injeção de uma biblioteca simulado um código malicioso pôde ser identificada através da comparação de instantâneos de memória coletados em diferentes assim como foi possível extraír o conteúdo da parte legível da memória onde o código malicioso está alocado. 
%
...
%
Como alguns códigos malicioso são capazes de manipular o retorno de funções do kernel, recomenda-se para trabalhos futuros a incorporação a \fancyname uma forma de realizar a extração do conteúdo de memória do espaço do kernel \textit{kernel space}.