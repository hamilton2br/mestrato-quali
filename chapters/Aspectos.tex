...
%
Uma cadeia de custódia ótima deve tornar visível o estado da evidência antes, durante e após a interação com o processo de investigação \cite{LuisDigitalChainOfCustody:2016}, pois alguns processos investigativos podem causar alteração da evidência na forma que foi coletada, como por exemplo o reintegração dos arquivos que compoem uma base distribuída.
...
%
O acesso fácil a aumentos na capacidade de armazenamento e recursos de processamento como máquinas virtuais, balanceadores de carga e \textit{firewalls}, aumentou a quantidade elementos geradores de evidência.
%
Desta forma, a quantidade de dados a ser análisado em uma investigação foi crescendo até que em 2014, para que todo o back-log fosse analisado, seriam necessários 6 meses \cite{QuickIncreaseVolumeImpact:2014} 
\marcos{Legal ter um exemplo, mas precisa *discutir* esse exemplo. E daí que tinha 6 meses de backlog? O que isso tem a ver com nuvem?! Vc não explicou o cenário, então pra mim como leitor esse backlog pode ser de um servidor a um tiozinho que anota em papel a entrada de pessoas... Mais CLAREZA!!! - Hamilton: acho que foi}.
...
%
Ainda relacionado à coleta da evidência, nas soluções de infra estrutura física, o processo de coleta de evidência mencionado na seção anterior não traz grandes problemas pois os objetos ou indivíduos sob investigação estão diretamente relacionados ao equipamento removido.
%
