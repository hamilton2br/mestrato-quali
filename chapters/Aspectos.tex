...
Desde 2001, modelos de como deve ser conduzida uma investigação forense digital foram propostas. 
%
...
%
Tais modelos de investigação foram desenvolvidos antes da aparição de tecnologias de computação em nuvem e partem do princípio que o investigador tem acesso e controle sobre o sistema sob investigação. \cite{GrisposChallengesCloudComputing:2012}
%
