...
%
Ainda relacionado a coleta da evidência, nas soluções de infra estrutura física, o processo de coleta de evidência mencionado na seção anterior para infraestrutura física não traz grandes problemas pois os objetos ou indivíduos sob investigação estão diretamente relacionados ao equipamento removido.
%
